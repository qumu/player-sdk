...
<div className="qi-alert qi-alert--warning qi-alert--rounded qi-mb--4">
  ...
  <p>This SDK is considered legacy. No new features will be added and we will discontinue the SDK on April 1<sup>st</sup>, 2023.</p>
  <a href="/migration#migration-from-legacy-to-the-new-sdk-v10">Learn how to migrate to the new SDK &rarr;</a>
</div>
