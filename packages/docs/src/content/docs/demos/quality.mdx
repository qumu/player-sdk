...
<Playground>
  <Fragment slot="actions">
    ...
    <hr/>
    <PlaygroundButton type="get" command="setLevel" value={-1}>Auto</PlaygroundButton>
    <PlaygroundButton type="get" command="setLevel" value={4}>1080p</PlaygroundButton>
    <PlaygroundButton type="get" command="setLevel" value={3}>720p</PlaygroundButton>
    <PlaygroundButton type="get" command="setLevel" value={2}>480p</PlaygroundButton>
    <PlaygroundButton type="get" command="setLevel" value={1}>240p</PlaygroundButton>
  </Fragment>
